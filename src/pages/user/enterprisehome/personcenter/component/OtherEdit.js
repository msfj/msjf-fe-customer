  ...
  render() {
    return (
      <Fragment>
        <Row gutter={20}>
          <Col span={6}>
            <Item label="联系人姓名" colon={false}>
              <Input size="large" defaultValue={'邓紫棋'}/>
            </Item>
          </Col>
          <Col span={6}>
            <Item label="手机号" colon={false}>
              <Input size="large" defaultValue={'18700000000'}/>
            </Item>
          </Col>
          <Col span={6}>
            <Item label="联系人身份证号" colon={false}>
              <Input size="large" value={'411888888888888888'} />
            </Item>
          </Col>
          <Col span={6}>
            <Item label="成立时间" colon={false}>
              <Input size="large" value={'411888888888888888'} />
            </Item>
          </Col>
          <Col span={12}>
...
export default Form.create()(OtherEdit);
