...
export default class EnterpriseInfoComponent extends Component {
  ...
  infoTitle(props) {
    return <div style={props.style} className={`${styles.infoTitle} ${props.className}`}>
      <i />
  ...
  render() {
    return <div className={styles.changeEtpInfo}>
      ...
      <div className={styles.titleBlock}>
        ...
        <span className={outStyles.font24}>
          公司名称公司名称公司名称
                         </span>
        <div className={`${styles.typeBlock} ${outStyles.font14}`}>
          拟设立
         </div>
        <i />
        <p>审批中</p>
      ...
      <div className={styles.detailContent}>
        ...
        <Row gutter={20} className={styles.row}>
          ...
          <Col className={styles.col} span={12}>
            <img className={styles.agreementImg} src="" alt="注册地址租赁协议"/>
          </Col>
          <Col className={styles.col} span={12}>
            <img className={styles.agreementImg} src="" alt="名称准和书"/>
          </Col>
        </Row>
        {/* 基本信息 */}
        ...
        <p className={`${outStyles.font16} ${outStyles.mb10}`}>
          主要负责人（1）从业经历介绍
                         </p>
